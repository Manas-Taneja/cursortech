...
export default function CookieConsent() {
  ...
  return (
    <div className={`${quicksand.className} fixed bottom-0 left-0 right-0 bg-white dark:bg-gray-800 shadow-lg border-t border-gray-200 dark:border-gray-700 p-4 z-50`}>
